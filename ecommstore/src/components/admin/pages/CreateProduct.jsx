        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {/* Tag chip input */}
              <div className="w-full min-h-12 px-3 py-2 border border-gray-300 rounded-lg focus-within:border-black transition-colors flex flex-wrap gap-2 items-center cursor-text"
              ...
              >
                ...
                <input
                  ...
                  className="flex-1 min-w-30 outline-none bg-transparent text-sm py-0.5"
