'use client';
import Loading from '@/app/(main)/products/[...slug]/loading';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Welcome Text */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-(--text-heading) mb-2">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm text-(--text-primary)">Remember for 30 days</span>
              </label>
              <Link
            ...
            >
              {isLoading ? <Loader className='animate-spin w-full' /> : 'Sign In'}
            </button>
